...
function arcadeMenu(){clearTutorialState();musicSetMode('menu');cpHideCampaignOverlays();$('#mainMenu').classList.add('hidden');$('#arcadeResult').classList.add('hidden');$('#arcadeBriefing').classList.remove('hidden');refreshArcadeIntelAssist();window.CP_MENU=true}
function cpShowMenu(){
